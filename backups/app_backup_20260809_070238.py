...
for key, default in {
    ...
    "vitimas":       [{"nome": "", "documento": "", "sexo": "", "data_nascimento": None, "filicao": "", "naturalidade": "",
    ...
    with col2:
        with st.container(border=True):
            with st.form("login_form"):
                ...
                if submitted:
                    if user == "perito" and pwd == "icrim123":
                        st.session_state["autenticado"] = True
                        st.rerun()
                    else:
...
if st.session_state.preview_open:
    ...
    vitimas_list   = st.session_state.get("vitimas", [{"nome": "", "documento": "", "sexo": "", "data_nascimento": None, "filicao": "", "naturalidade": "", "vestes": "", "pertences": "", "localizacao": "", "posicao": "", "cabeca": "", "membros": "", "fenomenos": "", "lesoes": [""]}])
    ...
    if st.session_state["current_page"] == "2. DO LOCAL":
        ...
        with st.container(border=True):
            ...
            if st.button("➕ Adicionar Outra Vítima", key="btn_add_vitima"):
                st.session_state.vitimas.append({"nome": "", "documento": "", "sexo": "", "data_nascimento": None, "filicao": "", "naturalidade": "", "vestes": "", "pertences": "", "localizacao": "", "posicao": "", "cabeca": "", "membros": "", "fenomenos": "", "lesoes": [""]})
                st.rerun()
            ...
            try:
                ...
                def replace_para(para, var_dict):
                    for k, v in var_dict.items():
                        if f"«{k}»" in para.text:
                            new = para.text.replace(f"«{k}»", str(v) if v else "________")
